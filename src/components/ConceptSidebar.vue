...
import type { JsProblem, ConceptCategory } from "@/types/js-explorer";
import { categoryLabels } from "@/data/js-problems";

export default defineComponent({
  props: {
    problems: { type: Array as PropType<JsProblem[]>, required: true },
    activeProblemId: { type: String, default: null },
  },
  emits: ["select"],
  setup(props) {
    const grouped = computed(() => {
      const groups: Partial<Record<ConceptCategory, JsProblem[]>> = {};
