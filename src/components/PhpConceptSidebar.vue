...
import { categoryLabels } from "@/data/php-problems";

export default defineComponent({
  props: {
    problems: { type: Array as PropType<PhpProblem[]>, required: true },
    activeProblemId: { type: String, default: null },
  },
  emits: ["select"],
  setup(props) {
    const grouped = computed(() => {
      const groups: Partial<Record<ConceptCategory, PhpProblem[]>> = {};
